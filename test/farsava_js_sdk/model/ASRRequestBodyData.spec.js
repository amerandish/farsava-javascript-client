...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FarsavaJsClient.ASRRequestBodyData();
  });
  ...
  describe('ASRRequestBodyData', function() {
    it('should create an instance of ASRRequestBodyData', function() {
      // uncomment below and update the code to test ASRRequestBodyData
      //var instane = new FarsavaJsClient.ASRRequestBodyData();
      //expect(instance).to.be.a(FarsavaJsClient.ASRRequestBodyData);
    });
